...
import com.androiddevs.mvvmnewsapp.NewsAplication
...
class NewsViewModel(
    ...
    private suspend fun getSafeBreakingNews(countryCode: String){
        ...
        try {
            if(hasInternet()) {
                ...
                breakingNews.postValue(Resource.Error("Error no internet connection"))
            }
        } catch(t: Throwable){
    ...
    private suspend fun getSafeSearchNews(searchQuery: String){
        ...
        try {
            if(hasInternet()) {
                ...
                searchNews.postValue(Resource.Error("Error no internet connection"))
            }
        } catch(t: Throwable){
